const { Client, Collection, GatewayIntentBits, Partials , ActivityType , SlashCommandBuilder } = require("discord.js");
...
client.on('ready', () => {
    client.user.setPresence({
        activities: [{ name: `r.play url`, type: ActivityType.Listening }],
        status: 'dnd',
      });
   });
